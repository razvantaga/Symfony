 ...
 */
final class Version20240724100832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE description description LONGTEXT DEFAULT NULL, CHANGE image_path image_path VARCHAR(255) DEFAULT NULL');
    }
